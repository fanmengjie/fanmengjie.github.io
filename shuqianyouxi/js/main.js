var openid; 
requestByGET("http://bjh1013.applinzi.com/CountMoney/php/get_openid.php",function(res){
	openid = res;
});
...
function show_ranking_div(){
	...
	$url = "http://bjh1013.applinzi.com/CountMoney/php/get_ranking_list.php";
...
start_game_btn.onclick = function(){
	...
	var countNumberTimer = setInterval(function(){
		if (beginCount) {
			if(countNumber > 0){
				...
				requestByGET("http://bjh1013.applinzi.com/CountMoney/php/update_score.php?openid="+openid+"&score="+number ,function(score){
                	var high_score_span = getElementByID("highScore");
                    high_score_span.innerHTML = score;

                    requestByGET("http://bjh1013.applinzi.com/CountMoney/php/get_ranking.php?score="+score ,function(res){
                		var result_rank_span = getElementByID("result_rank");
                    	result_rank_span.innerHTML = parseInt(res) + 1;
               		 });
                    // 
                });
	...
	touch.on(".p2","touchstart",function(e){
		e.preventDefault();
	});
