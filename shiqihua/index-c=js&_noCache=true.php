...
var ctrl_id = "c";
var func_id = "f";
var webroot = "http://www.shiqihua7.com/";
var apifile = "api.php";
var lang= new Array();

function get_url(ctrl,func,ext){var url = "http://www.shiqihua7.com/index.php?c="+ctrl;if(func){url+="&f="+func;};if(ext){url+="&"+ext};return url;}
function api_url(ctrl,func,ext){var url = "http://www.shiqihua7.com/api.php?c="+ctrl;if(func){url+="&f="+func;};if(ext){url+="&"+ext};url+="&_noCache="+Math.random();return url;};
function api_plugin_url(id,func,ext){var url = "http://www.shiqihua7.com/api.php?c=plugin&f=index&id="+id+"&exec="+func;if(ext){url+="&"+ext};url+="&_noCache="+Math.random();return url;};
